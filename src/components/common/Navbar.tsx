        ...
        <header className="w-full bg-transparent  ">
            <div className="fixed top-0 left-0 right-0 z-50 py-4 md:py-6 z-50">
                <Container className=" gap-3 lg:gap-4  mx-auto flex items-center justify-between ">
                        ...
                        {navLinks?.map((link) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Gold Crown / Decorative Underline asset for active path */}
                                    {active && (
                    ...
                    {/* Desktop and Mobile Integrated Right Action Pod */}
                    <div className="bg-pod-gradient flex items-center h-14 md:h-15 gap-3 md:gap-4 rounded-xl py-2 px-3 md:px-8 border-[0.5px] border-ivory-400/60 shadow-xl lg:w-full max-w-116">
                        {/* Hide search, favorites on mobile screens to match design layout */}
                        ...
                        {/* 1. Shopping Cart Trigger (Visible Everywhere) */}
                        <CartDrawer>
                        ...
                        {/* 2. Profile Dropdown Component (Visible Everywhere) */}
                        <DropdownMenu>
                            <DropdownMenuTrigger
                                render={
                            ...
                            {/* Dark Styled Dropdown Content matching your menu overlay */}
                            <DropdownMenuContent
                                align="end"
                        ...
                        {/* 3. Mobile Hamburger Menu Trigger (Only Visible below 'lg' breakpoint) */}
                        <Sheet
                            open={mobileOpen}
                        ...
                        >
                            ...
                            >
                                {/* Drawer Header matching the design layout */}
