...
//     // 1. Updated isActive to check hash links properly
...
//     // 2. Scroll Handler for Hash Links
...
//     // Handle hash scrolling when coming from a different route (e.g. /shop -> /#about)
//     useEffect(() => {
//         if (location.hash) {
...
export const Navbar = () => {
    ...
    return (
        <header className="w-full bg-transparent">
            <div className="fixed top-0 left-0 right-0 z-50 py-4 md:py-6 pointer-events-none">
                <motion.div
