...
export const ContactSection = () => {
    return (
        <section className="w-full bg-black-700 mt-16 pt-12 md:pt-24 overflow-hidden">
            <Container>
                <div className="w-full  mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center ">
                    {/* Left Column: Champagne Bottle & Glass Graphic */}
                    <div className="relative w-full flex justify-center items-end h-full order-2 lg:order-1">
