                            ...
                            Array.from({ length: 6 }).map((_, idx) => (
                                ...
                                >
                                    <div className="flex items-center gap-2.5">
                                        <div className="size-3.5 rounded bg-neutral-800 animate-pulse" />
                                        <div className="h-3 w-24 bg-neutral-800/80 rounded animate-pulse" />
                                    </div>
                                    <div className="h-3 w-6 bg-neutral-800/50 rounded animate-pulse" />
                                </div>
                            ))
                        ) : categoriesList.length === 0 ? (
                            <p className="text-xs text-neutral-500 font-hanken italic">
